...
resource "azurerm_key_vault" "app" {
  ...
  access_policy {
   ...
   access_policy {
    tenant_id = azurerm_data_factory.adf[1].identity[0].tenant_id
    object_id = azurerm_data_factory.adf[1].identity[0].principal_id
    # application_id = azuread_service_principal.dwp_ad_spn.application_id
    ...
    secret_permissions = [
      ...
      access_policy {
    tenant_id = azurerm_data_factory.adf[2].identity[0].tenant_id
    object_id = azurerm_data_factory.adf[2].identity[0].principal_id
    # application_id = azuread_service_principal.dwp_ad_spn.application_id
    ...
    secret_permissions = [
      ...
      access_policy {
    tenant_id = azurerm_data_factory.adf[0].identity[0].tenant_id
    object_id = azurerm_data_factory.adf[0].identity[0].principal_id
    # application_id = azuread_service_principal.dwp_ad_spn.application_id
